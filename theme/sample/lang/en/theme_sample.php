...
/**
 * Strings for component 'theme_sample', language 'en'
 *
 * @package   theme_sample
...
<div class="well">
<h2>sample</h2>
<p><img class=img-polaroid src="sample/pix/screenshot.jpg" /></p>
</div>
<div class="well">
<h3>About</h3>
<p>sample is a modified Moodle bootstrap theme which inherits styles and renderers from its parent theme.</p>
<h3>Parents</h3>
...
<p><a href="sample/README.txt">How to copy and customise this theme.</a></p>
</div></div>';

$string['configtitle'] = 'sample';
...
$string['privacy:metadata'] = 'The sample theme does not store any personal data about any user.';
