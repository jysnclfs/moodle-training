...
/**
 * Privacy tests for theme_boostcopy.
 *
...
use \theme_boostcopy\privacy\provider;

/**
 * Unit tests for theme_boostcopy/classes/privacy/policy
 *
 * @copyright  2018 Adrian Greeve <adriangreeve.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_boostcopy_privacy_testcase extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_user_preferences() {
        ...
        $exportedpreferences = $writer->get_user_preferences('theme_boostcopy');
        $this->assertCount(1, (array) $exportedpreferences);
        $this->assertEquals('false', $exportedpreferences->{provider::DRAWER_OPEN_NAV}->value);
        $this->assertEquals(get_string('privacy:drawernavclosed', 'theme_boostcopy'),
        ...
        $this->assertEquals(get_string('privacy:drawernavopen', 'theme_boostcopy'),
                $exportedpreferences->{provider::DRAWER_OPEN_NAV}->description);
    }
}
