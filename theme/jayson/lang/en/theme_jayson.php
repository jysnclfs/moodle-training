...
/**
 * Strings for component 'theme_jayson', language 'en'
 *
...
<div class="well">
<h2>jayson</h2>
<p><img class=img-polaroid src="jayson/pix/screenshot.jpg" /></p>
</div>
<div class="well">
<h3>About</h3>
<p>jayson is a modified Moodle bootstrap theme which inherits styles and renderers from its parent theme.</p>
<h3>Parents</h3>
...
<p><a href="jayson/README.txt">How to copy and customise this theme.</a></p>
</div></div>';

$string['configtitle'] = 'jayson';
...
$string['pluginname'] = 'jayson';
$string['privacy:metadata'] = 'The jayson theme does not store any personal data about any user.';
